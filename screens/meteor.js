...
import { Text, View, Alert, SafeAreaView, FlatList, Platform, StyleSheet, StatusBar, Image, ImageBackground, Dimensions} from 'react-native';
        ...
        return(
            <View>
                <ImageBackground source={bg_img} style={styles.backGroundImage}>
                    <View style={styles.gifCantainer}>
                        <Image source={speed}
